...
#     def setUp(self):
#         self.user = User.objects.create_user(username="suresh", password="messi")
#         self.token = Token.objects.create(user=self.user)
#         self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token.key)

#         self.stream = models.StreamPlatform.objects.create(
#             name="Netflix", about="#1 Platform", website="http://www.netflix.com"
#         )
...
#         self.stream = models.StreamPlatform.objects.create(
#             name="Netflix", about="#1 Platform", website="http://www.netfliex.com"
#         )
